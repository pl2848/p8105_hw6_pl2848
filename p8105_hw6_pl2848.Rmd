...
Then, the idea is to take out non-significant variables one at a time starting with the highest p-value. Here, I use one function to help me to do it.
```{r}
...
birth_weight_prediction = brw_clean %>% 
