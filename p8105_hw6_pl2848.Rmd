...
homicide = read_csv("data/homicide-data.csv") %>% 
  mutate(city_state = str_c(city, ", ", state),
         solve_status = as.numeric(disposition == "Closed by arrest"),
...
city_state = unique(homicide$city_state)
purrr::map(city_state, fit_logistic)
odds_city_state = tibble(city_state = unique(homicide$city_state),
                         model = purrr::map(city_state, fit_logistic)) 
