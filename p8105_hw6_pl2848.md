...
Since I want to use a mlr model and our x is less than 20 (not that
much), I can use backward elimination to get the optimal model.
...
Then, the idea is to take out non-significant variables one at a time
starting with the highest p-value (But I used AIC instead). Here, I use
one function to help me to do it.
